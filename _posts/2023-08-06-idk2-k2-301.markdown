...
## Latent vs Async
Latent and Async are both used to describe a task that can execute in a non-blocking way. While the terms are interchangable latent is primarily used in Blueprints and async is primarily used in C++.
