...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{% link _posts/2023-07-13-idk2-k2-101.markdown %}">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="{% link _posts/2023-08-06-idk2-k2-301.markdown %}">Next</a>
    </li>
  </ul>
</nav>
